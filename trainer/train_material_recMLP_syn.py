'''
@File    :   train_material_recMLP_syn.py
@Time    :   2023/02/27 12:11:57
@Author  :   Zhen Li 
...
class MatRecMLPTrainSynRunner():
    def __init__(self,**kwargs):
        ...
        self.mat_scheduler = torch.optim.lr_scheduler.LambdaLR(self.mat_optimizer, lr_lambda=lambda x: lr_schedule(x, 0.9))
    ...
    def run(self):
        ...
        for epoch in range(self.start_epoch, self.nepochs + 1):
            ...
            for data_index, (gt_item) in enumerate(self.train_dataloader):
                ...
                loss = self.mat_loss(preds, gt_color, self.cur_iter)
